	...
	{#snippet content()}
		...
		>
			...
			<div class="flex flex-wrap items-end gap-5">
				...
				<p class="text-lg">IBAN CH85 0076 9441 4721 0200 1</p>
				<p class="text-lg">Oder: Bezahlung per TWINT unter diesem ↗ <a href="https://go.twint.ch/1/e/tw?tw=acq.sGZu1zkzT0aZyvZ233nYMU8Xp1puBm-itMl-a5b6zPbGD4K0aIFr1dHETMT5592P." target="_blank">Link</a></p>
			</div>
